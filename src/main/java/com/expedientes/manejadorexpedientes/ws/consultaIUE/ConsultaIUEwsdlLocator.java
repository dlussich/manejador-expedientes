...
public class ConsultaIUEwsdlLocator extends org.apache.axis.client.Service implements com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdl {
    ...
    public com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlPortType getconsultaIUEwsdlPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlPortType getconsultaIUEwsdlPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlBindingStub _stub = new com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlBindingStub _stub = new com.expedientes.manejadorexpedientes.ws.consultaIUE.ConsultaIUEwsdlBindingStub(new java.net.URL(consultaIUEwsdlPort_address), this);
                _stub.setPortName(getconsultaIUEwsdlPortWSDDServiceName());
                return _stub;
            }
        }
